...
public class MockTrackDaoImp implements TrackDao {
    ...
    static {
        MockTrackDaoImp.tracks = new HashMap<BigInteger, Track>() {
            ...
            {
                put(new BigInteger("1"), new Track(new BigInteger("1"), 2, System.currentTimeMillis(), "Seattle"));
                put(new BigInteger("2"), new Track(new BigInteger("3"), 4,  System.currentTimeMillis(), "Tacoma"));
                put(new BigInteger("3"), new Track(new BigInteger("5"), 6,  System.currentTimeMillis(), "Redmond"));
            }
        };
    }
